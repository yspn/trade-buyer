!function() {
  function t(i) {
      ...
      if (!(-1 !== location.href.indexOf("itemlist/list_bought_items") || -1 !== location.href.indexOf("itemlist/listBoughtItems.htm")))
          return "";
      for (; t && "TBODY" !== t.nodeName; )
          t = t.parentNode;
  ...
  o.use("dom,event,cookie,ajax,ua", function(o, n, a, l, r, s) {
      ...
      /tablet/i.test(v)), k = f.g_config || {}, D = 0, S = function() {
          ...
          return t.indexOf("tmall.com") > -1 ? (i = "tmall.com",
          x = "otherx") : t.indexOf("daily.tmall.net") > 0 ? (i = "daily.tmall.net",
          x = "otherx") : i = t.indexOf("taobao.net") > 0 ? "taobao.net" : "taobao.com",
          i;
      ...
      BROWSER_LOG = ["ie", "firefox", "chrome", "safari", "opera"],
      STATUS_MAP = [1, 2, 10, 8, 12, 12, 12],
      Light = {
          ...
          addonIsOK: function(i) {
              var t = this;
              return location.href.indexOf("topen") > -1 ? (i && i.call(null, !1),
              g = !1,
              !1) : 1 == o.unparam(l.get("x")).c ? (i && i.call(null, !0),
              g = !0,
              !0) : (o.isBoolean(g) ? i && i.call(null, g) : this._checkWangWangInstalled(function(e) {
                  e || t._log("wwgw.light.notInstallClient"),
                  g = e,
                  i && i.call(null, g);
              }),
              i ? void 0 : g);
          ...
          initStart: function() {
              ...
              if (!N) {
                  ...
                  ("g_config"in f && "appId"in f.g_config && -1 != f.g_config.appId || "tstart"in t || "tdog"in t) && o.ready(function() {
                      var t = m.getElementsByTagName("head")[0] || m.documentElement
                        , e = (m.createElement("link"),
                      m.createElement("script"))
                        , o = function(i, t) {
                          var e = (t = t || location.hostname).split(".")
                            , o = e.length;
                          return o <= 2 ? t : ((i = i || 1) > o - 2 && (i = o - 2),
                          e.slice(i).join("."));
                      }(2)
                        , n = !/daily/i.test(location.host) ? "g.alicdn.com" : "assets.daily.taobao.net/g"
                        , a = location.protocol + "//" + n + "/aliww/web.ww.im/0.2.1/scripts/adapter.js";
                      "etao.com" != o && (e.src = a,
                      t.insertBefore(e, t.firstChild),
                      !i.addonIsOK() && f.g_config.toolbar && f.g_config.toolbar.delay && (f.g_config.toolbar.delay = 0));
                  });
              }
          },
          light: function(i) {
              ...
              function e(i, t, e, a) {
                  a && s._log("wwgw.light.degradeCount"),
                      ...
                      r({
                          ...
                          success: function(i) {
                              ...
                              if (i.success) {
                                  if (e(t, o, l),
                                  u)
                                      if (i.enableDegrade && i.degradeInfo) {
                                          var r = i.degradeInfo;
                                          if (a = +a,
                                          r.endTime - r.beginTime > 86400) {
                                              r.beginTime = a;
                                              var s = a + 86400;
              ...
              i = n.get(i) || m.body;
              var s = this
                , c = n.query(".J_WangWang", i)
                , d = c.length;
              if (0 !== d) {
                  var g, p, w, _ = [], b = [];
                  for (w = 0; w < d; ++w)
                      p = s._getParamsFromData(c[w]),
                      _.push(p),
                      g = p.nick,
                      b.push(h(g));
                  C = _[0].from || C;
          ...
          _lightToken: function(i, s, d) {
              var g = this
                , p = n.create('<a href="javascript: void(0);" target="_blank"></a>')
                , m = s.from
                , u = s.encode ? w(s.nick) : s.nick
                , _ = m + u
                , v = s.item
                , y = s.items
                , I = s.portal
              ...
              i.className = "ww-light ww-" + s.icon,
              p.className = "ww-" + s.display,
              1 === d ? (n.addClass(p, "ww-online"),
              p.title = ONLINE_MSG.DEFAULT,
              k.appId && 4 == k.appId && (p.title = ONLINE_MSG.SNS),
              ...
              a.on(p, "click", function(i) {
                  g._log("wwgw.1.37"),
                  g._log("wwgw.light.click");
                  var n = o.unparam(l.get(x))
                    , a = g.data[S]
                    , s = unescape((l.get("_nk_") || l.get("tracknick") || l.get("l") && l.get("l").split("::")[0] || "").replace(/\\u/g, "%u"));
                  if ((g.addonIsOK() || n && 1 == n.e) && i.preventDefault(),
                  g.addonIsOK() || (i.preventDefault(),
                  !g._isOtherHost())) {
                      var m = "";
                      if (!a.dispatched && d < 4 && -1 == a.userId.indexOf(":")) {
                          ...
                          r.getScript(B + h(a.userId) + "&charset=utf-8" + m + "&fromId=" + C + h(s), function() {
                              var i = w(f.realcid);
                              i && i !== a.userId && (a.userName = i.substring(8),
                              a.userId = i),
                              a.dispatched = !0,
                      ...
                      W ? e("aliim:sendmsg?" + g._paramUserInfo(a, null, p)) : (e("aliim:sendmsg?" + g._paramUserInfo(a, null, p)),
          ...
          _directToTBLogin: function(i) {
              var t = location
                ...
                , a = t.hash
                , l = t.href
                , r = "https://login." + T + "/member/login.jhtml?f=top";
              "wwlight"in (n = n ? o.unparam(n.substring(1)) : {}) && delete n.wwlight,
              i && (n.wwlight = i),
              n = o.param(n),
              l = h(l = e + "?" + n + a),
              t.href = r + "&redirectURL=" + l;
          },
          _openTBLoginPopup: function(i) {
              ...
              "wwlight"in (r = r ? o.unparam(r.substring(1)) : {}) && delete r.wwlight,
              i && (r.wwlight = i,
              d.isSearch() ? (e = r.q,
              delete r.q,
              r.wwlight = i) : r.wwlight = i),
              r = o.param(r),
              this.isSearch() && e && (r = "q=" + e + "&" + r),
              c = l + "?" + r + s;
              var p = location;
              ...
              if (f)
                  ...
                  t(f),
                  a.on(n.get(".btn-close", f), "click", function() {
                  ...
                  g)
                      m = "//www.taobao.com/go/act/share/loginsuccess.php";
                  else
                      var m = "//www.daily.taobao.net/go/act/share/loginsuccess.php";
                  var u = "https://login." + T + "/member/login.jhtml?style=mini&full_redirect=false&redirect_url=" + m
                    , h = f.getElementsByTagName("iframe")[0];
                  h.src = u,
                  a.on(h, "load", function() {
                      O() && (location.href = c);
                  });
              }
          },
          _isOtherHost: function() {
              var t = location.hostname
                , e = ["tmall.net", "tmall.com", "taobao.com", "daily.taobao.net"]
                , o = e.length;
              for (i = 0; i < o; i++)
                  if (t.indexOf(e[i]) > -1)
                      return !1;
          ...
          isSearch: function() {
              ...
              for (i = 0; i < e; i++)
                  if (o.host.indexOf(t[i] > -1))
                      return !0;
          },
          _paramUserInfo: function(i, t, e) {
              var o = i.userId || i.siteid + i.touid
                , n = "";
              return t && (o = h(o)),
              6 != J ? "uid=" + o.split("cntaobao")[1] + "&tositeid=" + i.fromSite + "&status=" + i.status + "&suid=" + i.portalId : (e && e.parentNode && (n = e.parentNode.getAttribute("data-items") || ""),
          ...
          _openChatDialog: function(i, t) {
              ...
              r.addonIsOK()) {
                  ...
                  if (s.firefox) {
                      ...
                      if (g)
                          n.css(g, "display", "block"),
                          n.css("#J_WebWangWangPluginNoticeMask", "display", "block");
                      else {
                          ...
                          g = n.get("#J_WebWangWangPluginNotice"),
                  ...
                  if (!W)
                      return void r._openWebWW();
                  if (I)
                      r._openDialogBySelectionDialog(i, t, 2);
                  else {
          ...
          _openChatDialogInUnIE: function(i, t) {
              ...
              if (o.plugin) {
                  ...
                  if (s.webkit && n && o.numberify(o.plugin.NPWWVersion()) < 1.005)
          ...
          _createSelectionDialog: function() {
              var i = this
                , t = o.unparam(l.get(x));
              if (i.selectionDialog)
                  (e = i.selectionDialog).style.display = "block";
              else {
                  ...
                  a.on(e, "click", function(a) {
                      var r = a.target;
                      if ("J_Windows8_Btn_Yes" === r.id) {
                          var s = n.attr(n.get(".win8-slt"), "data-value");
                          n.get("#J_Window8_remember").checked ? (t.c = parseInt(s),
                          l.set(x, o.param(t), 365, S, "/"),
                          i._destorySelectionDialog()) : e.style.display = "none",
                          i._openDialogBySelectionDialog(i.userInfo, i.link, s);
                      } else
                          "J_Windows8_Btn_No" === r.id || "J_Windows8_Btn_Close" === r.id ? e.style.display = "none" : n.hasClass(r, "J_Windows8_selection_item") && !n.hasClass("win8-slt") && (n.addClass(r, "win8-slt"),
          ...
          _destorySelectionDialog: function() {
              var i = this;
              n.remove(i.selectionDialog),
              a.remove(i.selectionDialog, "click"),
              i.selectionDialog = null;
          },
          ...
          _checkWangWangInstalled: function(i) {
              ...
              if (this._log("wwgw.1.38"),
              location.href.indexOf("topen") > -1)
                  return e = !1,
              ...
              if (a)
                  ...
                  void (i && i.call(null, e));
              if (!e && y)
                  return e = t._checkWangWangVersion(),
                  void (i && i.call(null, e));
              if (navigator.mimeTypes["application/ww-plugin"]) {
                  var r = m.createElement("embed");
                  return r.setAttribute("type", "application/ww-plugin"),
                  n.css(r, "visibility", "hidden"),
                  n.css(r, "width", 0),
                  n.css(r, "height", 0),
                  m.body.appendChild(r),
                  "function" == typeof r.NPWWVersion ? t.numberify(r.NPWWVersion()) >= 1.003 && (e = !0) : p = !0,
                  t.plugin = r,
                  void (i && i.call(null, e));
              }
              ...
              e && this._log("wwgw.1.39"),
              e;
          },
          localServer: function(i, t) {
              var e = this;
              if (e._log("wwgw.light.localServer"),
              this._log("wwgw.1.40"),
              i)
                  var o = setTimeout(function() {
                      i.call(null, !1);
                  }, 1500);
              t = t || ("https:" == location.protocol ? "4013" : "4012"),
              r({
                  dataType: "jsonp",
          ...
          _checkWangWangVersion: function() {
              ...
              try {
                  ...
                  try {
                      new ActiveXObject("WangWangX.WangWangObj"),
                      J = 5;
                  } catch (t) {
                      i = !1;
                  }
          ...
          _getParamsFromData: function(i) {
              var t = n.attr(i, "data-encode") || !1
                , e = n.attr(i, "data-nick") || "";
              t && (e = w(e));
              var o, a = {
                  nick: e,
