...
!function(e) {
  ...
  (function(e) {
      var t, r = n(1), i = n(2), o = n(3), a = n(6), u = n(9), c = n(15), s = e, l = (s.document,
      {}), f = {
          version: "3.3.7",
      ...
      try {
          s.AWSCInner && s.AWSCInner.register("umidPCModule", "umpc", f)
      } catch (p) {}
  }
  ).call(t, function() {
      return this
...
, function(e, t) {
  function n(e) {
      ...
      this._value = null,
      this._reason = null,
      void (f(e) && e(o(this.resolve, this), o(this.reject, this)))) : new n(e)
  }
  function r(e, t, n) {
      return function(r) {
          if (f(t))
  ...
  n.prototype = {
      ...
      then: function(e, t) {
          var i = new n
            , o = r(i, e, "resolve")
            , a = r(i, t, "reject");
          return this._state === s ? o(this._value) : this._state === l ? a(this._reason) : (this._onFulfilled.push(o),
...
, function(e, t) {
  ...
  n.hash = function(e, t) {
      ...
      var i, o, a, u = e.length / 4 + 2, c = Math.ceil(u / 16), s = new Array(c);
      for (i = 0; i < c; i++)
          for (s[i] = new Array(16),
          a = 0; a < 16; a++)
              s[i][a] = e.charCodeAt(64 * i + 4 * a) << 24 | e.charCodeAt(64 * i + 4 * a + 1) << 16 | e.charCodeAt(64 * i + 4 * a + 2) << 8 | e.charCodeAt(64 * i + 4 * a + 3);
      s[c - 1][14] = 8 * (e.length - 1) / Math.pow(2, 32),
      s[c - 1][14] = Math.floor(s[c - 1][14]),
      s[c - 1][15] = 8 * (e.length - 1) & 4294967295;
      var l, f, d, p, h, m = 1732584193, g = 4023233417, v = 2562383102, T = 271733878, S = 3285377520, C = new Array(80);
      for (i = 0; i < c; i++) {
          for (o = 0; o < 16; o++)
              C[o] = s[i][o];
          for (o = 16; o < 80; o++)
              C[o] = n.ROTL(C[o - 3] ^ C[o - 8] ^ C[o - 14] ^ C[o - 16], 1);
          for (l = m,
          f = g,
          d = v,
          p = T,
...
, function(e, t, n) {
  (function(t) {
      function r(e, t) {
          c.set("_um_" + e + "_" + h.storeKey, t)
      }
      function i(e) {
          return c.get("_um_" + e + "_" + h.storeKey)
      }
      function o(e, t) {
      ...
      function u(e, t) {
          ...
          return r ? r.value = t : (r = v.createElement("input"),
          r.type = "hidden",
          r.name = "um_token",
          r.value = t,
          e.appendChild(r)),
      ...
      var c = n(7)
        ...
        , T = function(e) {
          ...
          if (e.serviceUrl)
              ...
              var n = e.serviceLocation;
              "string" == typeof n && (n = [n],
              e.serviceLocation = n),
              f.each(n, function(e, n) {
                  t[n] = m[e]
              })
          }
          e.serviceUrlList = t,
      ...
      T.prototype = {
          getToken: function(e) {
              ...
              if (e)
                  return this.serverTokenMap[e] || this.clientToken;
              var t = this.options.serviceLocation[0];
              return this.serverTokenMap[t] || this.clientToken
          },
          init: function() {
              var e = this.options;
              this.serverTokenMap = {},
              ...
              1 === e.serviceUrlList.length && (o(e.formId, this.getToken()),
              e.closeImage || f.log(e.serviceUrlList[0].replace("um.json", "clear.png") + "?xt=" + this.getToken() + "&xa=" + e.appName));
              var t = p.get(h.storeKey);
              t && f.each(e.serviceLocation, function(e) {
                  i(e) || r(e, t.value)
              }),
              this.run()
          },
          run: function() {
              ...
              e.status = 2;
              var n = d.init(t, e);
              f.allSettled(n).then(function() {
                  var t = {};
                  f.each(n, function(e, n) {
                      null != e._value && (f.isObject(e._value) ? f.extend(t, e._value) : t[n] = e._value)
                  }),
                  f.extend(e.data, t),
                  e.send()
              })["catch"](function() {})
          ...
          getData: function(e) {
              var t = i(e);
              return this.data.xs = t,
              f.toJson(this.data)
          },
          send: function() {
              function e(e, t) {
                  var a = i.serviceLocation[t];
                  e && e.id ? (n.status = 255,
                  r(a, e.id)) : n.status = 200;
                  try {
                      i.callback(e)
                  } catch (u) {}
                  e.tn && (n.serverTokenMap[a] = e.tn,
                  1 === d.length && o(i.formId, e.tn)),
                  ++l === d.length && (n.defer.resolve(e),
                  c.set(h.storeTimeKey, new Date - n.startTime))
              }
              function t(e) {
                  u || (u = !0,
                  n.defer.reject(e),
                  i.errorCallback && i.errorCallback(e))
              }
              var n = this
                , i = n.options;
              if (i.noRequest) {
                  ...
                  return void n.defer.resolve()
              }
              n.status = 4;
              var u, l = 0, d = i.serviceUrlList;
              f.each(d, function(r, o) {
                  var a = i.serviceLocation[o]
                    , u = "ENCODE~~V01~~" + s.encode(n.getData(a));
                  f.post(r, u, i.jsonp).then(function(t) {
                      e(t, o)
                  })["catch"](t)
              })
          }
  ...
  (function(t) {
      ...
      var i = t
        ...
        , l = function() {
          ...
          var t = +new Date
            , n = u.get(c);
          n ? n = n.value : (n = t + r(11),
          s ? a.set(c, n) : o.set(c, n, null, 3650, "/"));
          var l = n + t + r(3);
          return e.token = l,
          "C" + l
      };
  ...
  e.exports = {
      ...
      get: function(e) {
          ...
          (t = n.value) ? {
              ...
              type: 2,
              value: t
          } : (t = e === a.storeKey && u ? i.get("um") || i.get(e) : i.get(e),
          t ? {
              type: 16,
              value: t
          } : void 0)
  ...
  (function(t) {
      ...
      r.extend(f, {
          ...
          getModVersion: function() {
              var e, t = 0;
              if (c.plugin && (e = d("Alipay webmod control", "application/alidcp"),
              e && (t = 1)),
              c.ActiveXObject && (e = p("Alim.webmod")))
                  try {
                      t = 1,
...
, function(e, t, n) {
  (function(t) {
      ...
      l.singleton)
        ...
        , T = v.document
        , S = v.navigator
        , C = "https://local.alipcsec.com:6691/umid/getumid"
        , y = {
          type: function() {
              return "pc"
          },
          ...
          ms: function() {
              return s.get(f.storeTimeKey)
          },
          erd: function() {
              var e = o.defer();
              return /Android/.test(S.userAgent) ? void e.reject() : (S.mediaDevices && S.mediaDevices.enumerateDevices ? navigator.mediaDevices.enumerateDevices().then(function(t) {
      ...
      y.xh = function(e) {
          if (!/Win/.test(S.platform))
              return "";
          if (i())
              return "";
          var t = "";
          return l.jsonp(C, "").then(function(e) {
      ...
      var M = function() {
          ...
          s = s.concat(l);
          for (var f = [], d = 0, p = s.length; d < p; d++)
              c(s[d]) && f.push(s[d]);
          return f
      };
        ...
        , A = function() {
          var e = []
            ...
            , n = [{
              ...
              getVersion: function(e, t) {
                  for (var n = "1", r = "0", i = "0"; e.IsVersionSupported(n + "." + r + "." + i); )
                      n++;
                  for (n--; e.IsVersionSupported(n + "." + r + "." + i); )
                      r++;
                  for (r--; e.IsVersionSupported(n + "." + r + "." + i); )
                      i++;
                  return i--,
                  n + "." + r + "." + i
              }
      ...
      y.plugin = function() {
          if (p.CORS) {
              var e = [];
              return p.plugin ? e = x() : p.ActiveXObject && (e = A()),
              {
                  epl: e.length,
                  ep: a.hash(e.join(",")),
                  epls: g(e),
      ...
      e.exports = {
          init: function(e, t) {
              var n = {};
              return l.each(y, function(r, i) {
                  try {
                      var a = r(e, t);
                      "undefined" == typeof a ? n[i] = o.reject() : l.isObject(a) ? a instanceof o ? n[i] = a : a.promise instanceof o ? (setTimeout(function() {
                          a.reject(i + ": timeout")
                      }, 3e3),
                      n[i] = a.promise) : n[i] = o.resolve(a) : n[i] = o.resolve(a)
                  } catch (u) {}
              }),
              n
          }
