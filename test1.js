...
!function(a, b) {
    ...
    function l() {
        ...
        var i = "api";
        ("taobao.com" === g || "tmall.com" === g) && (i = "h5api"),
        t.mainDomain = g,
        t.subDomain = h,
        t.prefix = i
    }
    ...
    n.prototype.__processRequestType = function(c) {
        var d = this
          , e = this.options;
        if (t.H5Request === !0 && (e.H5Request = !0),
        t.WindVaneRequest === !0 && (e.WindVaneRequest = !0),
        e.H5Request === !1 && e.WindVaneRequest === !0) {
            if (!b.windvane || parseFloat(e.WindVaneVersion) < 5.4)
                throw new Error("WINDVANE_NOT_FOUND::缺少WindVane环境")
        } else
            e.H5Request === !0 ? e.WindVaneRequest = !1 : "undefined" == typeof e.WindVaneRequest && "undefined" == typeof e.H5Request && (b.windvane && parseFloat(e.WindVaneVersion) >= 5.4 ? e.WindVaneRequest = !0 : e.H5Request = !0);
        var f = a.navigator.userAgent.toLowerCase();
        return f.indexOf("youku") > -1 && e.mainDomain.indexOf("youku.com") < 0 && (e.WindVaneRequest = !1,
        e.H5Request = !0),
        e.mainDomain.indexOf("youku.com") > -1 && f.indexOf("youku") < 0 && (e.WindVaneRequest = !1,
        e.H5Request = !0),
        c ? c().then(function() {
            var a = e.retJson.ret;
            return a instanceof Array && (a = a.join(",")),
            e.WindVaneRequest === !0 && (!a || a.indexOf("PARAM_PARSE_ERROR") > -1 || a.indexOf("HY_FAILED") > -1 || a.indexOf("HY_NO_HANDLER") > -1 || a.indexOf("HY_CLOSED") > -1 || a.indexOf("HY_EXCEPTION") > -1 || a.indexOf("HY_NO_PERMISSION") > -1) ? (t.H5Request = !0,
            d.__sequence([d.__processRequestType, d.__processToken, d.__processRequestUrl, d.middlewares, d.__processRequest])) : void 0
        }) : void 0
    }
    ;
    var y = "_m_h5_c"
        ...
        c.WindVaneRequest !== !0 ? r.then(function() {
            ...
            d.indexOf("TOKEN_EMPTY") > -1 || c.CDR === !0 && d.indexOf("ILLEGAL_ACCESS") > -1 || d.indexOf("TOKEN_EXOIRED") > -1) {
                ...
                c.H5Request && ++c.failTimes < c.maxRetryTimes)
                    return b.__sequence([b.__processToken, b.__processRequestUrl, b.middlewares, b.__processRequest]);
    ...
    n.prototype.__requestJSON = function(b) {
        ...
        g.headers)
            for (var p in g.headers)
                i.setRequestHeader(p, g.headers[p]);
        return i.send(n),
        e.promise
    }
    ,
    n.prototype.__requestWindVane = function(a) {
        ...
        var m, n, o = "https" === location.protocol ? 1 : 0, p = f.isSec || 0, q = f.sessionOption || "AutoLoginOnly", r = f.ecode || 0;
    ...
    n.prototype.request = function(b) {
        ...
        c.options.H5Request && (c.constructor.__firstProcessor || (c.constructor.__firstProcessor = e),
        C = function(a) {
            c.constructor.__firstProcessor.then(a)["catch"](a)
        }
        ),
        ("get" === this.params.type && "json" === this.params.dataType || "post" === this.params.type) && (b.pageDomain = b.pageDomain || g(a.location.hostname),
        b.mainDomain !== b.pageDomain && (b.maxRetryTimes = 4,
        b.CDR = !0)),
        e
    }
    ,
